...
                     (1, win_count, item1, item2, item3, cname))

def read_build(item1, item2, item3, cname):
    return run_query("SELECT * FROM BUILD WHERE item1 = %s, item2 = %s, item3 = %s, cname = %s", (item1, item2, item3, cname), is_select=True)
...
                     (1, win_count, skill1, skill2, skill3, cname))

def read_skill_order(skill1, skill2, skill3, cname):
    return run_query("SELECT * FROM SKILL_ORDER WHERE skill1 = %s, skill2 = %s, skill3 = %s, cname = %s", (skill1, skill2, skill3, cname), is_select=True)
...
                     (1, win_count, slot1, slot2, slot3, slot4, slot5, slot6, cname))

def read_rune_page(slot1, slot2, slot3, slot4, slot5, slot6, cname):
    return run_query("SELECT * FROM RUNE_PAGE WHERE slot1 = %s, slot2 = %s, slot3 = %s, slot4 = %s, slot5 = %s, slot6 = %s, cname = %s", (slot1, slot2, slot3, slot4, slot5, slot6, cname), is_select=True)
